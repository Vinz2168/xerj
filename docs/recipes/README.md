...
| [Vector quantization](./vector-quantization.md) | Opt a `dense_vector` field into scalar8 (`int8_hnsw`) — kNN scored from ingest-time 1-byte-per-dim codes at recall@10 ≈ 0.998; the scoring working set is 4× smaller than the f32 vectors (see [#392](https://github.com/xerj-org/xerj/issues/392)) | [`quant_demo.py`](../examples/vector-quantization/quant_demo.py) |
